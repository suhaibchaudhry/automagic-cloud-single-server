...
function Window(socket, initialScript) {
  var self = this;
...
Window.prototype.createTab = function(initialScript) {
  //initialScript = '/home/digerpaji/ggw/automagic/automagic';
  var tab = new Tab(this, this.socket, initialScript);
  //tab.handler(initialScript+"\r");
  //console.log(initialScript);
  if(typeof initialScript != 'undefined') {
	  setTimeout(function() {
		tab.handler(initialScript+"\r");
	  }, 500);
  }
